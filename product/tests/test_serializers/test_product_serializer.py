...
class TestProductSerializer(TestCase):
    ...
    def test_serializer_valid_data(self):
        ...
        expected_data = {
            ...
            'category': [
                {'title': self.category1.title, 'slug': self.category1.slug, 'description': self.category1.description, 'active': self.category1.active},
                {'title': self.category2.title, 'slug': self.category2.slug, 'description': self.category2.description, 'active': self.category2.active},
            ],
            'categories_id': []
        }
